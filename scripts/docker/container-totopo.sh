...
CLOUD_SERVICE_VAR=${K_SERVICE}
CLOUD_VERSION_VAR=${K_REVISION}
CLOUD_REGION_VAR=${CLOUD_REGION}
...
/app/Totopo \
    ...
    --cloud-service ${CLOUD_SERVICE_VAR} \
    --cloud-version ${CLOUD_VERSION_VAR} \
    --cloud-region ${CLOUD_REGION_VAR} \
